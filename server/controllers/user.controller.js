...
import forgotPasswordTemplate from '../utils/forgotPasswordTemplete.js'
  ...
  try {
    ...
    const updatedUser = await UserModel.findByIdAndUpdate(
      user._id,
      {
        ...
        forgot_password_expiry: expireTime.toISOString(), // Store expiry in ISO format
      },
    ...
    try {
      await sendEmail({
        sentTo: email,
        subject: 'Forgot Password - ZipMart',
